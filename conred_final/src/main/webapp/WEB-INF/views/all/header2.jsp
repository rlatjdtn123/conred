...
<style type="text/css">
	...
	#profilebox{width:200px;height:40px;float:right;position: relative; bottom:55px;left:-10px;}
	.profile{float:right; height:100%;line-height: 40px;padding-right:10px;}
	#navibox{width:380px;height:30px;float:right;position: relative; padding-right:5px;}
