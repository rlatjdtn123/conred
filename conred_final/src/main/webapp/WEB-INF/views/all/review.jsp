...
/* 	#sticky{position: sticky; top:71px;} */
	...
	#modal_Btn{margin-left: 280px; height: 50px; width: 100px;background-color: #F2F2F2; border: 0;}
...
<div id="container"> 
	<div id="main">
		<span id="main2">리뷰 ★★★★★ &nbsp;<b style="font-size: 25px;">4.7</b>/5 &nbsp; &nbsp; &nbsp;후기2343개|답변2033개</span><button id="modal_Btn">리뷰 작성</button><br>
