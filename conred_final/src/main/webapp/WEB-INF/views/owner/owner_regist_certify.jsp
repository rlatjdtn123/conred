...
<div id="container">
	<form action="owner_insert_certify.do" method="post" enctype="multipart/form-data">
		<div id="tle">
			<div id="regist">
				사업자등록번호 인증
				<div style="color:red;font-size:12px;">*모두 필수사항입니다.</div>
			</div> 
			<table class="table table-hover" >
				<tr>
					<td>사업자등록번호</td>
					<td>
						<input class="number_l form-control" type="text" name="store_license_number" placeholder='0000000000' required="required"/>
<!-- 						만약 3칸에서 받아와줄거라면 이거쓰기 -->
...
<!-- 							<input type="file" id="biz" name="biz" class="upload-hidden" required="required"> -->
...
<!-- 							<input type="file" id="sales" name="sales" class="upload-hidden" required="required"> -->
							<div class="subinfo firstsub">*글자가 잘 보이지 않을경우 매장승인이 되지 않을 수 있습니다.</div>
						</div>
					</td>
				</tr>
				<tr>
					<td>사업자명</td>
					<td>
						<input class="form-control" type="text" name="store_owner_name" placeholder='김댕댕' required="required"/>
<!-- 						<input type="hidden" name="store_owner_name" value="111"/>테스트용 -->
				...
				<tr>
					<td>사업자 휴대폰번호</td>
					<td>
						<input class="number_l form-control" type="text" name="store_owner_phone" placeholder='01012341234' required="required"/>
<!-- 						3칸쓴다면 아래사용 -->
...
<!-- 						<input type="hidden" name="store_owner_phone" value="111"/>테스트용 -->
				...
				<tr>
					<td>인증번호 입력</td>
					<td>
						<input class="form-control" type="text" name="store_owner_phone_certify" placeholder='인증번호 6자리'required="required"/>
				...
				<tr>
					<td>입점 약관</td>
					<td>
						입점 약관에 동의하시겠습니까? <input name="store_agreement" value="Y" type="checkbox" required="required"/>
<!-- 						<input type="hidden" name="store_agreement" value="Y"/>테스트용 -->
						<button type="button"  class="btn modal_Btn"> 입점약관</button>
					</td>
				</tr>
			</table>
		</div>
  		...
  		<!-- Modal content-->
   		<div class="modal-content" >
     		<div class="modal-header"> 
     			<span style="font-size:30px;">(주)어디가개 매장 입점약관</span>| 시행일자 : 2018년 04월 02일
