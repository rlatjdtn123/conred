			...
			<div id="regist">
				...
				<table class="table table-hover" >
					<tr>
						...
						<td><input type="text" name="owner_id" required="required" class="owner_infos" value=""/></td>
					</tr>
					<tr>
						<td><span class="req"> </span>이름</td>
						<td><input type="text" name="owner_name" readonly="readonly" value="" class="owner_infos"/></td>
					</tr> 
	 				<tr> 
						<td><span class="req"> </span>이메일</td>
					<td> 
						<input type="text" name="owner_email1" readonly="readonly" class="owner_infos" value=""/>@
						<input value="" id="email" type="text" name="owner_email3" style="width:120px;" readonly="readonly" class="onwer_infos"/>
					...
					<tr>  
						<td>생년월일</td>
						<td>
							<input value="" style="height:26px;" type="text" onclick="changeType()" name="owner_birth" style="background-color: white;border:1px solid black;"/>
						</td>
					</tr>
					<tr>
						<td>성별</td>
					<td>
						<input type="text" readonly="readonly"  name="user_sex" value="" class="owner_infos"/>
					</td> 
					</tr>
				</table> 
		</div> 
