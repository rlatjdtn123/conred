...
<style type="text/css">
	...
	.main_home{transition: all ease 0.5s;width: 200px;height: 80px; border: 2px solid grey;float: left;margin-left: 205px;text-align: center;font-size: 40px;padding-top: 10px;}	
