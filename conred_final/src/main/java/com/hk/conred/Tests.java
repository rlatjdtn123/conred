...
//     */
//	@RequestMapping(value = "GetDailyBankAccountLog.do", method = {RequestMethod.GET,RequestMethod.POST})
//    public void GetDailyBankAccountLog(Locale locale, Model model) throws RemoteException {
//		logger.info("입출금 조회  {}.", locale);
//        String certKey = "DCDEBDA2-8E3F-4054-8454-97C0078C63E5";            // 인증키
//        String corpNum = "1048147984";            // 바로빌 회원 사업자번호 ('-' 제외, 10자리)
//        String id = "syhnz1102";                 // 바로빌 회원 아이디
//        String bankAccountNum = "110383724609";     // 계좌번호
//        String baseDate = "20200701";           // 기준날짜
...
//
//        System.out.println(result);
//        System.out.println(result.getBankAccountLogList());
